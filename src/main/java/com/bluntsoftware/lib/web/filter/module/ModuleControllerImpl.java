...
public class ModuleControllerImpl {
    ...
    public static   Map<String,Object> config(String module_name,String name,HttpServletRequest request) {
        Map<String,Object> serverInfo = getServerInfo(request);
        String address =  serverInfo.get("serverPath") + "/" + module_name + "/" +  name + "/" ;
        Map<String,Object>  map = new HashMap<String, Object>();
            map.put("mod",module_name);
            map.put("name",name);
