...
@Table(name = "\"material\"")
public class Material implements CustomDomain<Material> {
    ...
    @SequenceGenerator(name = "material_id_seq", allocationSize = 1, sequenceName = "material_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
    ...
    public Object clone() throws CloneNotSupportedException {
        Material entity = (Material)super.clone();
        entity.setId(null);
        return entity;
    }
}