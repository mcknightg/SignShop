...
@Table(name = "\"customer\"")
public class Customer implements CustomDomain<Customer> {
    ...
    @SequenceGenerator(name = "customer_id_seq", allocationSize = 1, sequenceName = "customer_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
    ...
    public Object clone() throws CloneNotSupportedException {
        Customer entity = (Customer)super.clone();
        entity.setId(null);
        return entity;
    }
}